...
def test_trade_license_extract_UAQ():
    client = APIClient()
    file_path = os.path.join(os.path.dirname(__file__), "DED-UAQ.pdf")

    # Additional form-data fields
    extra_fields = {
        "issuingAuthority": "Umm Al Quwain Department of Economic Development",
